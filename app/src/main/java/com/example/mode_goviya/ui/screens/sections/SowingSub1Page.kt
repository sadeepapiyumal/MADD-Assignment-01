...
fun SowingSub1Page(navController: NavController) {
    val descriptionText = "\nවී වගාව සඳහා සෑම විටම පළවීමේ ශක්තියෙන් වැඩි, වෙනස් වී වර්ග සමග මිශ්‍රව නොමැති, " +
    ...
    Column(
        ...
        SubTopicCardWithTable(
            title = "මහ කන්නයේ බිම් සැකසීම සහ වැපිරීම සඳහා\nසුදුසු වී වගා කාලසටහන\n",
            description = "",
            tableData = listOf(
        ...
        SubTopicCardWithTable(
            title = "යල කන්නයේ බිම් සැකසීම සහ වැපිරීම සඳහා\nසුදුසු වී වගා කාලසටහන\n",
            description = "",
            tableData = listOf(
                listOf("වයස් කාණ්ඩය", "බිම් සැකසීම", "වැපිරීම"),
